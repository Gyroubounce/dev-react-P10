...
exports.getAllUsers = exports.searchUsers = exports.removeContributor = exports.addContributor = exports.deleteProject = exports.updateProject = exports.getProject = exports.getProjects = exports.createProject = void 0;
...
const getAllUsers = async (req, res) => {
    try {
        ...
        (0, response_1.sendSuccess)(res, "Utilisateurs récupérés", { users });
    }
    catch (error) {
        console.error("Erreur lors de la récupération des utilisateurs:", error);
        (0, response_1.sendServerError)(res, "Erreur lors de la récupération des utilisateurs");
    }
};
